    ...
    const sampleUsers = [
      {
        ...
        firstName: 'Demo',
        lastName: 'User',
        cognitivePatterns: cognitivePatterns[0] ?? null,
        learningPreferences: learningPreferences[0] ?? null,
        totalXP: 150,
        currentStreak: 3,
        longestStreak: 7,
        emailVerified: true,
      },
      {
        ...
        firstName: 'Test',
        lastName: 'Learner',
        cognitivePatterns: cognitivePatterns[1] ?? null,
        learningPreferences: learningPreferences[1] ?? null,
        totalXP: 75,
        currentStreak: 1,
        longestStreak: 3,
        emailVerified: true,
      },
      {
        ...
        firstName: 'Student',
        lastName: 'Driver',
        cognitivePatterns: cognitivePatterns[2] ?? null,
        learningPreferences: learningPreferences[0] ?? null,
        totalXP: 300,
        currentStreak: 5,
        longestStreak: 12,
