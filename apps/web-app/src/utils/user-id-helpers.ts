 ...
 */
export function toStringUserId(userId: number | string | null | undefined): string | undefined {
 ...
 * Handles number, string, null, and undefined inputs
 */
export function toNumberUserId(userId: number | string | null | undefined): number | undefined {
  if (userId === null || userId === undefined) {
    return undefined
  }
 ...
 */
export function requireStringUserId(userId: number | string | null | undefined): string {
 ...
 */
export function requireNumberUserId(userId: number | string | null | undefined): number {
