  ...
  return (
    ...
    >
      <div className="flex lg:flex-row flex-col items-start">
        <div className="c-search-bar w-full lg:flex-row flex-col gap-24 relative group">
          {!isUserInsider && (
            <div className="absolute top-full left-0 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
