...
export function useSetupDrawingPage({
  ...
  editorLocalStorageValue: { code: string; storedAt: string }
  setEditorLocalStorageValue: (value: { code: string; storedAt: string }) => void
  code: { code: string; storedAt: string }
}) {
