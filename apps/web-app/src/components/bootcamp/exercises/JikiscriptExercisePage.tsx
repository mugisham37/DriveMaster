...
export function JikiscriptExercisePage({
  ...
  const {
    ...
    customFunctions: custom_functions?.map(cf => ({
      name: cf.name,
    ...
    try {
      ...
      if (exercise.config?.tests_type && exercise.config?.exercise_functions) {
        ...
        setTestOutput({
          ...
          passed_bonus_tests: testResults.filter(t => t.name.includes('bonus')).every(t => t.passed)
        })
      } else {
      ...
      <div className="exercise-header">
        ...
        <div className="exercise-meta">
          ...
          <div className="exercise-status">
            ...
            {solution.passed_bonus_tests && <span className="passed">✓ Bonus Tests Passed</span>}
          </div>
        </div>
      </div>
      ...
      <div className="exercise-body">
        <div className="exercise-content">
          ...
          <div className="exercise-editor">
            <h3>{language === 'jikiscript' ? 'Jikiscript' : 'JavaScript'} Code</h3>
            <textarea
              value={jikiCode}
          ...
          <div className="exercise-actions">
            ...
            <a 
              href={links.custom_fns_dashboard}
        ...
        <div className="exercise-output">
          ...
          {lastError && (
            <div className="error-output" style={{ color: 'red', marginBottom: '1rem' }}>
              <h4>Error:</h4>
          ...
          <details>
            ...
            <div className="config-details">
              {exercise.config.project_type && (
                <p><strong>Project Type:</strong> {exercise.config.project_type}</p>
              )}
              {exercise.config.tests_type && (
                <p><strong>Tests Type:</strong> {exercise.config.tests_type}</p>
              )}
