...
const TracksList = ({
  ...
  const {
    ...
    CACHE_KEY,
    request as Request<APIResponse>
  );
  ...
  const sortedTracks = resolvedData?.tracks?.sort(
    (a: StudentTrack, b: StudentTrack) => {
      const aLastTouched = (a as StudentTrack & { lastTouchedAt?: string })
        .lastTouchedAt;
      const bLastTouched = (b as StudentTrack & { lastTouchedAt?: string })
        .lastTouchedAt;
    ...
    <div className="tracks-list">
      <section className="c-search-bar">
        <div className="lg-container container">
          ...
          />
          <TagsFilter
            tags={tagOptions.flatMap((option) =>
          ...
          <OrderSelect
            ...
            onChange={() => null}
            options={[
              { value: "last_touched_first", label: "Last Touched First" },
            ]}
          />
        </div>
      </section>
      <section className="lg-container container">
        ...
        {resolvedData && (
          <ResultsZone isFetching={isFetching}>
            {sortedTracks ? <List tracks={sortedTracks} /> : null}
          </ResultsZone>
        )}
      </section>
    </div>
