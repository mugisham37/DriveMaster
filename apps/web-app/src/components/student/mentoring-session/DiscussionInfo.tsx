...
import { MentorDiscussion, Iteration, MentoringSessionDonation } from '../../../types'
  ...
  return (
    <div className="discussion-info">
      ...
      <div className="participants">
        ...
        <span>Mentor: {mentor.name} (@{mentor.handle})</span>
      </div>
      ...
      <div className="timestamps">
        ...
        <span>Updated: {new Date(discussion.updatedAt).toLocaleDateString()}</span>
      </div>
    </div>
  )
}
