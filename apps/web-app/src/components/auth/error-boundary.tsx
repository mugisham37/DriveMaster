...
export function AuthErrorBoundary({
  ...
  const fallbackRender = React.useCallback(({ error, resetErrorBoundary }: FallbackProps) => {
    const authError = AuthErrorHandler.processError(error, context)
 ...
 */
export function LoginErrorBoundary({ children, ...props }: Omit<AuthErrorBoundaryProps, 'context'>): React.ReactElement {
  return (
 ...
 */
export function OAuthErrorBoundary({ children, ...props }: Omit<AuthErrorBoundaryProps, 'context'>): React.ReactElement {
  return (
 ...
 */
export function TokenRefreshErrorBoundary({ children, ...props }: Omit<AuthErrorBoundaryProps, 'context'>): React.ReactElement {
  return (
