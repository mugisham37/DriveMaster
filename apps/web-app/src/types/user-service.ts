...
export type ActivityRecommendationsResponse = ApiResponse<
...
export const isUserServiceError = (
  error: unknown,
...
export const isNetworkError = (error: UserServiceError): boolean =>
  error.type === "network";
export const isValidationError = (error: UserServiceError): boolean =>
  error.type === "validation";
export const isAuthorizationError = (error: UserServiceError): boolean =>
  error.type === "authorization";
export const isServiceError = (error: UserServiceError): boolean =>
  error.type === "service";
export const isTimeoutError = (error: UserServiceError): boolean =>
  error.type === "timeout";
export const isCircuitBreakerError = (error: UserServiceError): boolean =>
