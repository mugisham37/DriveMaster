...
export type ExtractRequest<T extends keyof AuthServiceEndpoints> =
  AuthServiceEndpoints[T]["request"];
export type ExtractResponse<T extends keyof AuthServiceEndpoints> =
  AuthServiceEndpoints[T]["response"];

// Type guards for error classification
export const isValidationError = (error: AuthError): error is ValidationError =>
  error.type === "validation";
export const isNetworkError = (error: AuthError): error is NetworkError =>
  error.type === "network";
export const isAuthenticationError = (
  error: AuthError,
): error is AuthenticationError => error.type === "authentication";
export const isAuthorizationError = (
  error: AuthError,
): error is AuthorizationError => error.type === "authorization";
export const isOAuthError = (error: AuthError): error is OAuthError =>
  error.type === "oauth";
export const isServerError = (error: AuthError): error is ServerError =>
  error.type === "server";
