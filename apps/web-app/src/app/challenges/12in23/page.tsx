...
export const metadata: Metadata = {
  ...
  description: 'Learn 12 programming languages in 2023! Each month features different languages with themed exercises.',
}
...
async function get12in23Data() {
  ...
  const decemberTracks: Track[] = [
    { slug: 'coldfusion', title: 'ColdFusion', iconUrl: 'https://assets.exercism.org/images/tracks/coldfusion.svg', course: false },
    { slug: 'groovy', title: 'Groovy', iconUrl: 'https://assets.exercism.org/images/tracks/groovy.svg', course: false },
    { slug: 'lua', title: 'Lua', iconUrl: 'https://assets.exercism.org/images/tracks/lua.svg', course: true },
    { slug: 'vimscript', title: 'VimScript', iconUrl: 'https://assets.exercism.org/images/tracks/vimscript.svg', course: false },
    { slug: 'wren', title: 'Wren', iconUrl: 'https://assets.exercism.org/images/tracks/wren.svg', course: false },
  ]
  ...
  const featuredExercises = [
    {
      slug: 'all-your-base',
      title: 'All Your Base',
      description: 'Convert a number, represented as a sequence of digits, to another base.',
    ...
    },
    {
      ...
      iconUrl: 'https://assets.exercism.org/images/exercises/run-length-encoding.svg'
    }
  ]
  ...
  const allTracks = [
    { id: 'javascript', slug: 'javascript', title: 'JavaScript', iconUrl: 'https://assets.exercism.org/images/tracks/javascript.svg' },
    { id: 'python', slug: 'python', title: 'Python', iconUrl: 'https://assets.exercism.org/images/tracks/python.svg' },
    { id: 'ruby', slug: 'ruby', title: 'Ruby', iconUrl: 'https://assets.exercism.org/images/tracks/ruby.svg' },
    { id: 'go', slug: 'go', title: 'Go', iconUrl: 'https://assets.exercism.org/images/tracks/go.svg' },
    { id: 'rust', slug: 'rust', title: 'Rust', iconUrl: 'https://assets.exercism.org/images/tracks/rust.svg' },
    { id: 'java', slug: 'java', title: 'Java', iconUrl: 'https://assets.exercism.org/images/tracks/java.svg' }
  ]
  ...
  return {
    ...
    badgeProgressExerciseEarnedCount: badgeProgressExercises.filter(e => e.earnedFor).length
  }
}
            ...
            <div className="mr-auto max-w-[860px]">
              ...
              <div className="shadow-baseZ1 grid grid-cols-2 gap-20 py-20 px-20 rounded-8 bg-backgroundColorB">
                <div className="flex-shrink">
                  <h2 className="text-h4 mb-2">Start by watching our December Diversions overview video 👉</h2>
              ...
              <h2 className="text-h3 mt-32 mb-2">Learn and Earn (the badge)!</h2>
              <p className="text-p-large mb-20">
                ...
                <GraphicalIcon icon="concepts" className="w-[14px] h-[14px] filter-purple inline mx-[-4px]" />
                ).
              </p>
                  ...
                  >
                    {track.course && (
                      <div className="rounded-circle bg-backgroundColorA p-4 shadow-baseZ1 absolute top-[-7px] right-[-7px]">
                        <GraphicalIcon icon="concepts" className="w-[14px] h-[14px] filter-purple" />
                      </div>
                    )}
                    <Image 
                      src={track.iconUrl} 
              ...
              <ul className="text-p-large list-disc pl-16 c-highlight-links">
                <li className="mb-4">
                  ...
                  <Link href="https://forum.exercism.org/tag/12in23" className="underline">#12in23 tag on our forums</Link>,
                  chatting on our <Link href="https://exercism.org/r/discord" className="underline">Discord Server</Link>,
                  or using the <strong className="font-semibold">#12in23</strong> hashtag around social media!
                </li>
              </ul>
            </div>
              ...
              <div className="bg-backgroundColorD rounded-8 py-16 px-24 mb-24 border-1 border-borderColor7">
                ...
                <ul className="text-p-base list-disc pl-16">
                  <li className="mb-4">
                    ...
                    <strong className="font-semibold text-textColor2">December Diversions Kickoff</strong>
                  </li>
                  <li className="mb-4">
                    <div className="font-medium text-textColor6 text-14 leading-100">
                      Dec 20, 2023 - 16:00 UTC
                    </div>
                    <strong className="font-semibold text-textColor2">Lua Deep Dive</strong>
                  </li>
                </ul>
              </div>
                ...
                <div className="grid grid-cols-2 gap-12">
                  ...
                  >
                    ...
                    <Image 
                      ...
                      className="mb-8 block w-full rounded-5"
                    />
                    <div className="text-center text-h6">The Official #12in23 Calendar</div>
                  </Link>
                </div>
                ...
                {badgeProgressExercises.length > 0 && (
                  <>
                    <h2 className="text-h6 mt-20 mb-12">
                      Published Exercises
                      <div className="inline text-14"> ({badgeProgressExerciseEarnedCount} / {badgeProgressExerciseCount} so far)</div>
                    </h2>
                    <div className="grid grid-cols-5 gap-12">
                      {badgeProgressExercises.map((exerciseProgress) => (
                        <div key={exerciseProgress.slug} className="relative block">
                          {exerciseProgress.earnedFor ? (
                            <Link href={`/tracks/${exerciseProgress.earnedFor}/exercises/${exerciseProgress.slug}`}>
                              <Image 
                            ...
                            <Image 
                              ...
                              title={`Solve ${exerciseProgress.slug} in ${exerciseProgress.trackSlugs.join(', or ')}`}
                            />
                          )}
                        </div>
                      ))}
              ...
              return (
                ...
                >
                  ...
                  {count >= 5 ? (
                    ...
                    <>
                      <progress className="progress-bar" value={count} max={5} />
                      <div className="count">{count} / 5 exercises completed</div>
                    </>
                  )}
                </Link>
              )
