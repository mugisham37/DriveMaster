...
export function useEmailNotifications() {
  ...
  const sendBadgeNotification = useCallback(async (
    userEmail: string,
    userHandle: string,
    badgeName: string,
    badgeIconUrl: string
  ...
  const sendMentoringNotification = useCallback(async (
    type: 'mentorStartedDiscussion' | 'mentorRepliedToDiscussion' | 'studentRepliedToDiscussion',
    userEmail: string,
    userHandle: string,
