...
export function useJikiscriptExecution(
  options: JikiscriptExecutionOptions = {}
) {
  ...
  const executeJikiscript = useCallback(
          ...
          frames: [
            {
              location: { line: 1 },
              status: "success",
              result: `Mock execution result for: ${code.substring(0, 50)}...`,
            },
          ],
          output: "Mock output",
        };
