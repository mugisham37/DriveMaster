 ...
 */
function createAuthRedirect(req: NextRequest, redirectTo: string = '/auth/signin'): NextResponse {
...
function handleProtectedRoute(req: NextRequest, tokenPayload: TokenPayload | null): NextResponse {
  if (!tokenPayload) {
...
function handleMentorRoute(req: NextRequest, tokenPayload: TokenPayload | null): NextResponse {
...
function handleInsiderRoute(req: NextRequest, tokenPayload: TokenPayload | null): NextResponse {
  // First check authentication
  if (!tokenPayload) {
    return createAuthRedirect(req)
  }
...
function handleAdminRoute(req: NextRequest, tokenPayload: TokenPayload | null): NextResponse {
  // First check authentication
  if (!tokenPayload) {
    return createAuthRedirect(req)
  }
...
function handleAuthRoute(req: NextRequest, tokenPayload: TokenPayload | null): NextResponse {
