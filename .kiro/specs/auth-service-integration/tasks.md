...
- [ ] 3. Authentication Service API Client
  - [ ] 3.1 Create TypeScript interfaces matching auth-service DTOs and response types
  ...
  - [ ] 3.2 Implement core authentication API methods
  ...
  - [ ] 3.3 Implement OAuth API methods for all five providers
  ...
  - [ ] 3.4 Add profile and session management API methods
