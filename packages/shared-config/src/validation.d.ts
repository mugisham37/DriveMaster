...
export declare function createSuccessResponse<T>(data: T, requestId?: string): {
    success: true;
    data: T;
    meta: {
        timestamp: string;
...
export declare function createErrorResponse(code: string, message: string, details?: any, requestId?: string): {
    success: false;
    error: {
        code: string;
        message: string;
...
export declare const LearningEventSchema: z.ZodObject<{
    ...
    eventType: z.ZodEnum<["question_answered", "session_started", "session_ended", "content_viewed"]>;
