...
export declare function createElasticsearchConnection(config: ElasticsearchConfig): ElasticsearchConnection;
export declare function checkElasticsearchHealth(client: Client): Promise<boolean>;
export declare class IndexManager {
    private client;
    constructor(client: Client);
    createIndex(name: string, mapping: Record<string, any>, settings?: Record<string, any>): Promise<boolean>;
...
export declare class SearchManager {
    ...
    bulkIndex<T>(index: string, documents: Array<{
        id: string;
        document: T;
    }>): Promise<boolean>;
